...
//        });
    ...
    public int getdistrictId() throws JSONException {

        pickedDistrictId = dbHandler.getDistrictId(district.getText().toString());
        Log.d(TAG, "getdistrictId: "+pickedDistrictId);
        return pickedDistrictId;
