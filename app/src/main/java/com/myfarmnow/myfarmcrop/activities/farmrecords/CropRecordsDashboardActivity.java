...
public class CropRecordsDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_records_dashboard);
...
//       to be called in "crop records"
        ...
        cropsLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openCrops = new Intent(CropRecordsDashboardActivity.this, CropsListActivity.class);
        ...
        incomeExpenseLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openIncomeExpense = new Intent(CropRecordsDashboardActivity.this, CropFieldsListActivity.class);
