...
public class CropEmployeesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cropEmployeesListRecyclerAdapter = new CropEmployeesListRecyclerAdapter(this,dbHandler.getCropEmployees(CropDashboardActivity.getPreferences("userId",this)));
