...
public class CropDigitalWalletWithdrawActivity extends AppCompatActivity {
    ...
    public void initiateDeposit(){
        ...
        client.post(ApiPaths.CROP_WALLET_INITIATE_MOMO_WITHDRAW, params, new JsonHttpResponseHandler() {
            ProgressDialog dialog;
            @Override
            public void onStart() {

                dialog = new ProgressDialog(CropDigitalWalletWithdrawActivity.this);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    PENDING_WITHDRAW_REFERENCE_NUMBER = response.getString("referenceNumber");
                    finish();
                    Intent goToWallet = new Intent(CropDigitalWalletWithdrawActivity.this,CropWalletActivity.class);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                if(statusCode==401){
                    CropWalletAuthActivity.startAuth(CropDigitalWalletWithdrawActivity.this, true);
                }else if(statusCode == 500){
                    Toast.makeText(CropDigitalWalletWithdrawActivity.this, "Error Occurred Try again later", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(int statusCode, Header[] headers, String errorResponse,Throwable throwable) {
                ...
                Toast.makeText(CropDigitalWalletWithdrawActivity.this, "An error occurred Try again Later", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
