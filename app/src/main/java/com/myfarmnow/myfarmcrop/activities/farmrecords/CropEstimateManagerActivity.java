...
public class CropEstimateManagerActivity extends AppCompatActivity {
    ...
    public void initializeForm(){
        ...
        DashboardActivity.addDatePicker(estimateDateTxt,this);
...
//                        startActivity(toCropEmployeesList);
    ...
    public CropEstimate saveEstimate(){
        ...
        cropEstimate.setUserId(DashboardActivity.RETRIEVED_USER_ID);
    ...
    public void fillViews(){
        if(cropEstimate != null){
            DashboardActivity.selectSpinnerItemById(customersSp,cropEstimate.getCustomerId());
