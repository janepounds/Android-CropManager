...
public class CropSalesOrderPreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_sales_order_preview);
    ...
    public void initializeView(){
        ...
        dueDateTextView.setText(cropSalesOrder.getShippingDate());
        //termsTextView.setText(cropSalesOrder.getR());
        //orderNumberTextView.setText(cropSalesOrder.getOrderNumber());
...
//        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.screenshot);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            File filePath = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), cropSalesOrder.getNumber() + ".pdf");
            try {
    ...
    private void openEmail(){
        File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), cropSalesOrder.getNumber() + ".pdf");
        if (file.exists()) {
            ...
            mailIntent.putExtra(Intent.EXTRA_SUBJECT, "SalesOrder : "+cropSalesOrder.getNumber());
