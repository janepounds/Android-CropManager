...
import com.myfarmnow.myfarmcrop.fragments.wallet.LoansListFragment;
import com.myfarmnow.myfarmcrop.fragments.wallet.TransactionsListFragment;
...
public class WalletHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wallet_included_view = findViewById(R.id.wallet_fragment_home);
    }
    ...
    public void openTransactions(View view) {
        wallet_included_view.setVisibility(View.GONE);
        getSupportFragmentManager().beginTransaction().replace(R.id.wallet_fragment_container, new TransactionsListFragment()).commit();
...
//        startActivity(transactionActivity);
    ...
    public void openLoans(View view) {
        ...
        wallet_included_view.setVisibility(View.GONE);
        getSupportFragmentManager().beginTransaction().replace(R.id.wallet_fragment_container, new LoansListFragment()).commit();
