...
public class CropFertilizerApplicationManagerActivity extends AppCompatActivity {
    ...
    public void initializeForm(){
        ...
        for(CropInventoryFertilizer x: dbHandler.getCropFertilizerInventorys(DashboardActivity.getPreferences("userId",this))){
    ...
    public void saveFertilizerApplication(){
        ...
        fertilizerApplication.setUserId(DashboardActivity.getPreferences("userId",this));
