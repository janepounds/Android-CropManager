...
public class NotificationsTodayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        notificationsListRecyclerAdapter = new CropsNotificationsListRecyclerAdapter(getActivity(),dbHandler.getCropNotifications(DashboardActivity.getPreferences("userId",getActivity()), CropNotification.QUERY_KEY_TODAY));
