...
public class CropIncomeExpensesListRecyclerAdapter extends RecyclerView.Adapter<CropIncomeExpensesListRecyclerAdapter.IncomeExpenseViewHolder> {
    ...
    ImageView deleteButton, editButton;
        public IncomeExpenseViewHolder(View itemView) {
            ...
            deleteButton = itemView.findViewById(R.id.img_crop_income_expense_card_delete);
            editButton = itemView.findViewById(R.id.img_crop_income_expense_card_edit);
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent editIncomeExpense = new Intent(mContext, CropIncomeExpenseManagerActivity.class);
                    editIncomeExpense.putExtra("cropIncomeExpense",cropIncomeExpense);
                    mContext.startActivity(editIncomeExpense);
                }
            });
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new AlertDialog.Builder(mContext)
                            .setTitle("Confirm")
                            .setMessage("Do you really want to delete "+cropIncomeExpense.getItem()+" ?")
