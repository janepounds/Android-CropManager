...
import com.myfarmnow.myfarmcrop.models.currency_model.CurrencyList;
...
public class CurrencyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.buy_inputs_row_item_currency, parent, false);

            holder = new CurrencyAdapter.ViewHolder();

            holder.currencyName = convertView.findViewById(R.id.currency_name);
            holder.currencySelector = convertView.findViewById(R.id.cb_currency);
