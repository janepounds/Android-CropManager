...
public class CropHarvestListRecyclerAdapter extends RecyclerView.Adapter<CropHarvestListRecyclerAdapter.HarvestViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HarvestViewHolder holder, int position) {
        ...
        holder.harvestDateTxt.setText(harvest.getDate());
        holder.harvestMethodTxt.setText("("+harvest.getMethod()+")");
        holder.quantityTxt.setText(harvest.getQuantity()+" ");
        holder.unitsTxt.setText(harvest.getUnits());
        holder.statusTxt.setText(harvest.getStatus());
        holder.costTxt.setText(harvest.getCost()+"");
        holder.incomeGeneratedTxt.setText(harvest.getIncomeGenerated()+"");
        holder.priceTxt.setText(harvest.getPrice()+"");
        holder.quantitySoldTxt.setText(harvest.getQuantitySold()+"");
