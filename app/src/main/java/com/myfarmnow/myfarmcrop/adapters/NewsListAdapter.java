...
import com.myfarmnow.myfarmcrop.fragments.NewsDescription;
...
public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final com.myfarmnow.myfarmcrop.models.news_model.all_news.NewsDetails newsDetails = newsList.get(position);
