...
public class ProductReviewsAdapter extends RecyclerView.Adapter<ProductReviewsAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.buy_inputs_reviews, parent, false);
...
//        String review_date = review.getDateCreated().replaceAll("[a-zA-Z]", " ");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View itemView) {
            ...
            authore_name = itemView.findViewById(R.id.author_name);
            authore_date = itemView.findViewById(R.id.author_date);
            authore_message = itemView.findViewById(R.id.author_message);
            authore_rating = itemView.findViewById(R.id.author_rating);
            authore_img = itemView.findViewById(R.id.author_image);
        }
    }
