...
import com.myfarmnow.myfarmcrop.models.filter_model.get_filters.FilterOption;
import com.myfarmnow.myfarmcrop.models.filter_model.get_filters.FilterValue;
...
public class FilterProductsAdapter extends RecyclerView.Adapter<FilterProductsAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.buy_inputs_filters, parent, false);
