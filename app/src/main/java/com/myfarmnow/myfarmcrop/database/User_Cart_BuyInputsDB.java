...
public class User_Cart_BuyInputsDB {
    ...
    public static void initCartInstance() {
        AppSettingsDetails cartInfoInstanceFromAppSettingDetails = ((CropManagerApp) CropManagerApp.getContext().getApplicationContext()).getAppSettingsDetails();                        final String pkg = CropManagerApp.getContext().getApplicationContext().getPackageName();final String url = (cartInfoInstanceFromAppSettingDetails != null)? cartInfoInstanceFromAppSettingDetails.getSiteUrl() : "";final String settingURL = "http://ionicecommerce.com/testcontroller.php";
        RequestQueue queue = Volley.newRequestQueue(CropManagerApp.getContext().getApplicationContext());
