...
public class MyFarmDbHandlerSingleton extends SQLiteOpenHelper {
    ...
    public static final String CROP_MACHINE_TASK_TYPE = "type";
    ...
    public static final String CROP_MACHINE_SERVICE_STATUS = "status";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String crop_transplanting_insert_query = "CREATE TABLE IF NOT EXISTS " + CROP_TRANSPLANTING_TABLE_NAME+" ( "+CROP_TRANSPLANTING_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_TRANSPLANTING_OPERATOR+" TEXT NOT NULL, "+CROP_TRANSPLANTING_COST+" REAL NOT NULL "+" ) ";
        ...
        String crop_machine_task_insert_query = " CREATE TABLE IF NOT EXISTS " + CROP_MACHINE_TASK_TABLE_NAME + " ( " + CROP_MACHINE_TASK_ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + CROP_MACHINE_TASK_MACHINE_ID + " TEXT NOT NULL, " + CROP_MACHINE_TASK_START_DATE + " TEXT NOT NULL, " +
                ...
                + CROP_MACHINE_TASK_STATUS + " TEXT NOT NULL, " +CROP_MACHINE_TASK_TYPE + " TEXT NOT NULL, " + CROP_MACHINE_TASK_DESCRIPTION + " TEXT , " +CROP_MACHINE_TASK_REPEAT_UNTIL + " TEXT, " +CROP_MACHINE_TASK_DAYS_BEFORE + " REAL DEFAULT 0, " +CROP_MACHINE_TASK_COST + " REAL DEFAULT 0, " +
        ...
        String crop_note_insert_query = " CREATE TABLE IF NOT EXISTS " + CROP_NOTE_TABLE_NAME + " ( " + CROP_NOTE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + CROP_NOTE_PARENT_ID + " TEXT NOT NULL, " + CROP_NOTE_DATE + " TEXT NOT NULL, " + CROP_NOTE_CATEGORY + " TEXT, "  + CROP_NOTE_NOTES + " TEXT NOT NULL " + " ) ";
        ...
        String crop_irrigation_insert_query = "CREATE TABLE IF NOT EXISTS " + CROP_IRRIGATION_TABLE_NAME + " ( " +CROP_IRRIGATION_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT , " +
                ...
                CROP_IRRIGATION_REMINDERS+" TEXT NOT NULL, "+CROP_IRRIGATION_COST+" REAL DEFAULT 0 " + " ) ";
    ...
    public void  insertCropMachineService(CropMachineService service){
        ...
        contentValues.put(CROP_MACHINE_SERVICE_STATUS, service.getStatus());
    ...
    public ArrayList<CropMachineService> getCropMachineServices(String machineId){
        ...
        while (!res.isAfterLast()) {
            ...
            service.setStatus(res.getString(res.getColumnIndex(CROP_MACHINE_SERVICE_STATUS)));
    ...
    public void  insertCropMachineTask(CropMachineTask task){
        ...
        contentValues.put(CROP_MACHINE_TASK_TYPE, task.getType());
    ...
    public ArrayList<CropMachineTask> getCropMachineTasks(String machineId){
        ...
        while (!res.isAfterLast()) {
            ...
            task.setType(res.getString(res.getColumnIndex(CROP_MACHINE_TASK_TYPE)));
    ...
    public ArrayList<CropPaymentBill> getCropPaymentBills(String billId) {
        openDB();
        ArrayList<CropPaymentBill> array_list = new ArrayList();

        //hp = new HashMap();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery("select * from " + CROP_PAYMENT_BILL_TABLE_NAME + " where " + CROP_PAYMENT_BILL_USER_ID + " = " + billId, null);
        res.moveToFirst();
    ...
    public void  insertCropBill(CropBill bill){
        openDB();
        ContentValues contentValues = new ContentValues();
...
Log.d("CROP BILL INSERT QUERY", contentValues.toString());
    ...
    public void updateCropBill(CropBill bill) {
        openDB();
        ContentValues contentValues = new ContentValues();
        contentValues.put(CROP_BILL_USER_ID,bill.getUserId());
        contentValues.put(CROP_BILL_SUPPLIER_ID,bill.getSupplierId());
    ...
    public boolean deleteCropBill(String id) {
        openDB();
        database.delete(CROP_PRODUCT_ITEM_TABLE_NAME, CROP_PRODUCT_ITEM_ESTIMATE_ID + " = ? AND "+CROP_PRODUCT_ITEM_TYPE + " = ?", new String[]{id,CROP_PRODUCT_ITEM_TYPE_BILL});
    ...
    public ArrayList<CropBill> getCropBills(String userId){
        ...
        for (CropBill bill : array_list) {
            ...
            res = db.rawQuery( "select * from "+CROP_PRODUCT_ITEM_TABLE_NAME+" LEFT JOIN "+CROP_PRODUCT_TABLE_NAME+" ON "+CROP_PRODUCT_ITEM_TABLE_NAME+"."+CROP_PRODUCT_ITEM_PRODUCT_ID+" = "+CROP_PRODUCT_TABLE_NAME+"."+CROP_PRODUCT_ID+" where "+CROP_PRODUCT_ITEM_ESTIMATE_ID+" = "+ bill.getId()+" AND "+CROP_PRODUCT_ITEM_TABLE_NAME+"."+CROP_PRODUCT_ITEM_TYPE+" = '"+CROP_PRODUCT_ITEM_TYPE_BILL +"'", null );
            res.moveToFirst();
            while (!res.isAfterLast()) {
                CropProductItem item = new CropProductItem();
                item.setId(res.getString(res.getColumnIndex(CROP_PRODUCT_ITEM_ID)));
    ...
    public ArrayList<CropBill> getCropBillsBySupplier(String supplierId){
        ...
        for (CropBill bill : array_list) {
            ...
            res = db.rawQuery( "select * from "+CROP_PRODUCT_ITEM_TABLE_NAME+" LEFT JOIN "+CROP_PRODUCT_TABLE_NAME+" ON "+CROP_PRODUCT_ITEM_TABLE_NAME+"."+CROP_PRODUCT_ITEM_PRODUCT_ID+" = "+CROP_PRODUCT_TABLE_NAME+"."+CROP_PRODUCT_ID+" where "+CROP_PRODUCT_ITEM_ESTIMATE_ID+" = "+ bill.getId(), null );
            res.moveToFirst();
            while (!res.isAfterLast()) {
                CropProductItem item = new CropProductItem();
                item.setId(res.getString(res.getColumnIndex(CROP_PRODUCT_ITEM_ID)));
