...
public class MyFarmDbHandlerSingleton extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String crop_contact_insert_query = " CREATE TABLE IF NOT EXISTS "+ CROP_CONTACT_TABLE_NAME+ " ( "+CROP_CONTACT_ID+" INTEGER PRIMARY KEY AUTOINCREMENT , "+
                ...
                CROP_CONTACT_ADDRESS+" TEXT NOT NULL, "+CROP_CONTACT_PHONE_NUMBER+" TEXT NOT NULL, "+CROP_CONTACT_EMAIL+" TEXT, "+CROP_CONTACT_WEBSITE+" TEXT , "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+ " ) ";
        ...
        String crop_inventory_fertilizer_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_INVENTORY_FERTILIZER_TABLE_NAME+" ( "+CROP_INVENTORY_FERTILIZER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_INVENTORY_FERTILIZER_MICRO_NUTRIENTS_ZN+" REAL ,"+ CROP_INVENTORY_FERTILIZER_MICRO_NUTRIENTS_FE+" REAL ,"+ CROP_INVENTORY_FERTILIZER_MICRO_NUTRIENTS_NA+" REAL, "+CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+ " )";
        ...
        String crop_seeds_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_INVENTORY_SEEDS_TABLE_NAME+" ( "+CROP_INVENTORY_SEEDS_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
               ...
               CROP_INVENTORY_SEEDS_COST+" REAL ,"+CROP_INVENTORY_SEEDS_SUPPLIER+" TEXT ,"+CROP_INVENTORY_SEEDS_TGW+" TEXT ,"+CROP_INVENTORY_FERTILIZER_USAGE_UNIT+" TEXT, "+CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_inventory_spray_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_INVENTORY_SPRAY_TABLE_NAME+" ( "+CROP_INVENTORY_SPRAY_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_INVENTORY_SPRAY_COST+" REAL ,"+CROP_INVENTORY_SPRAY_SUPPLIER+" TEXT ,"+CROP_INVENTORY_SPRAY_EXPIRY_DATE+" TEXT ,"+CROP_INVENTORY_SPRAY_HARVEST_INTERVAL+" TEXT ,"+CROP_INVENTORY_SPRAY_USAGE_UNIT+" TEXT, "+CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_CROP_TABLE_NAME+" ( "+CROP_CROP_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_CROP_ESTIMATED_REVENUE+" REAL DEFAULT 0,"+CROP_CROP_RATE+" REAL DEFAULT 0,"+CROP_CROP_PLANTING_METHOD+" TEXT NOT NULL, "+CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_spraying_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_SPRAYING_TABLE_NAME+" ( "+CROP_SPRAYING_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_SPRAYING_RECURRENCE + " TEXT NOT NULL, " +CROP_SPRAYING_FREQUENCY + " REAL DEFAULT 0, " + CROP_SPRAYING_REMINDERS + " TEXT NOT NULL, " +CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" ) ";
        ...
        String crop_field_insert_query ="CREATE TABLE IF NOT EXISTS "+ CROP_FIELDS_TABLE_NAME +" ( "+ CROP_FIELD_ID +" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_FIELD_LAYOUT_TYPE+" TEXT ,"+CROP_FIELD_STATUS+" TEXT NOT NULL ,"+ CROP_FIELD_UNITS+" TEXT NOT NULL, "+CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_machine_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_MACHINE_TABLE_NAME+" ( "+CROP_MACHINE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_MACHINE_PURCHASED_FROM+" TEXT NOT NULL,"+CROP_MACHINE_STORAGE_LOCATION+" TEXT,"+CROP_MACHINE_PURCHASE_PRICE+" REAL NOT NULL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' " + " )";
        ...
        String crop_employee_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_EMPLOYEE_TABLE_NAME+" ( "+CROP_EMPLOYEE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_EMPLOYEE_PAY_AMOUNT+" REAL NOT NULL,"+ CROP_EMPLOYEE_PAY_RATE+" TEXT ,"+CROP_EMPLOYEE_PAY_TYPE+" TEXT NOT NULL,"+CROP_EMPLOYEE_SUPERVISOR+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_customer_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_CUSTOMER_TABLE_NAME+" ( "+CROP_CUSTOMER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_CUSTOMER_SHIP_ADDRESS_COUNTRY+" TEXT NOT NULL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        String crop_supplier_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_SUPPLIER_TABLE_NAME+" ( "+CROP_SUPPLIER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_SUPPLIER_INVOICE_ADDRESS_COUNTRY+" TEXT NOT NULL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        String crop_product_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_PRODUCT_TABLE_NAME+" ( "+CROP_PRODUCT_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_PRODUCT_DESCRIPTION+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_estimates_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_ESTIMATE_TABLE_NAME+" ( "+CROP_ESTIMATE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_ESTIMATE_CUSTOMER_NOTES+" TEXT ,"+  CROP_ESTIMATE_STATUS+" TEXT DEFAULT 'DRAFT' ,"+ CROP_ESTIMATE_TERMS_AND_CONDITIONS+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_estimate_item_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_PRODUCT_ITEM_TABLE_NAME+" ( "+CROP_PRODUCT_ITEM_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_PRODUCT_ITEM_RATE+" REAL NOT NULL, "+ CROP_PRODUCT_ITEM_TYPE+" TEXT NOT NULL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no', "+
        ...
        String crop_invoices_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_INVOICE_TABLE_NAME+" ( "+CROP_INVOICE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_INVOICE_CUSTOMER_NOTES+" TEXT ,"+ CROP_INVOICE_TERMS_AND_CONDITIONS+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_payment_item_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_PAYMENT_TABLE_NAME+" ( "+CROP_PAYMENT_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_PAYMENT_REFERENCE_NO+" TEXT , "+CROP_PAYMENT_NUMBER+" TEXT , "+CROP_PAYMENT_NOTES+" TEXT , "+CROP_PAYMENT_INVOICE_ID+" TEXT , "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no', "+" FOREIGN KEY ( "+CROP_PAYMENT_INVOICE_ID+") REFERENCES  "+CROP_INVOICE_TABLE_NAME+" ( "+CROP_INVOICE_ID+" ), " +
        ...
        String crop_income_expense_insert_query = " CREATE TABLE IF NOT EXISTS " + CROP_INCOME_EXPENSE_TABLE_NAME + " ( " + CROP_INCOME_EXPENSE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + CROP_INCOME_EXPENSE_DATE + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_USER_ID + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_TRANSACTION + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_ITEM +
                ...
                + CROP_INCOME_EXPENSE_PAYMENT_MODE + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_PAYMENT_STATUS + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_SELLING_PRICE + " REAL , " + CROP_INCOME_EXPENSE_CUSTOMER_SUPPLIER + " TEXT NOT NULL, " + CROP_INCOME_EXPENSE_CROP_ID + " TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' " + " ) ";
        ...
        String crop_sales_order_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_SALES_ORDER_TABLE_NAME+" ( "+CROP_SALES_ORDER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_SALES_ORDER_CUSTOMER_NOTES+" TEXT ,"+ CROP_SALES_ORDER_STATUS+" TEXT DEFAULT 'DRAFT' ,"+ CROP_SALES_ORDER_TERMS_AND_CONDITIONS+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_purchase_order_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_PURCHASE_ORDER_TABLE_NAME+" ( "+CROP_PURCHASE_ORDER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_PURCHASE_ORDER_NOTES+" TEXT ,"+ CROP_PURCHASE_ORDER_STATUS+" TEXT DEFAULT 'DRAFT' ,"+ CROP_PURCHASE_ORDER_TERMS_AND_CONDITIONS+" TEXT, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        CROP_ITEM_P_REMOVED + " REAL DEFAULT 0 , "+ CROP_ITEM_N_REMOVED + " REAL DEFAULT 0 , "+CROP_ITEM_K_REMOVED + " REAL DEFAULT 0 , "+
                CROP_ITEM_IS_FOR + " TEXT DEFAULT NULL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" ) " ;
        ...
        String crop_fertilizer_insert_query ="CREATE TABLE IF NOT EXISTS "+CROP_FERTILIZER_TABLE_NAME+" ( "+CROP_FERTILIZER_ID+" INTEGER PRIMARY KEY AUTOINCREMENT ,"+
                ...
                CROP_FERTILIZER_P_PERCENTAGE+" REAL,"+ CROP_FERTILIZER_K_PERCENTAGE+" REAL, "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' "+" )";
        ...
        String crop_notification_insert_query = " CREATE TABLE IF NOT EXISTS " + CROP_NOTIFICATION_TABLE_NAME + " ( " + CROP_NOTIFICATION_ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + CROP_NOTIFICATION_USER_ID + " TEXT NOT NULL, " +
                ...
                CROP_NOTIFICATION_TYPE + " TEXT NOT NULL DEFAULT 'Cultivate', "+ CROP_GLOBAL_ID +" INTEGER DEFAULT NULL ," + CROP_SYNC_STATUS+" TEXT DEFAULT 'no' " +" ) ";
    ...
    public void upGradingTablesFromVersion1ToVersion2(SQLiteDatabase db){
        ...
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SEEDS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SEEDS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SPRAY_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SPRAY_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CROP_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_CROP_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CULTIVATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_CULTIVATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_APPLICATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_APPLICATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SPRAYING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SPRAYING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FIELDS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_FIELDS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SOIL_ANALYSIS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SOIL_ANALYSIS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_EMPLOYEE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_EMPLOYEE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CUSTOMER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_CUSTOMER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SUPPLIER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SUPPLIER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PRODUCT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_PRODUCT_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_ESTIMATE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_ESTIMATE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PRODUCT_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_PRODUCT_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INVOICE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_INVOICE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INCOME_EXPENSE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_INCOME_EXPENSE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PAYMENT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_PAYMENT_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_TASK_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_TASK_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SALES_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SALES_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PURCHASE_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_PURCHASE_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PAYMENT_BILL_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_PAYMENT_BILL_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_BILL_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_BILL_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SETTINGS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SETTINGS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_NOTIFICATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_NOTIFICATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_TASK_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_TASK_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_NOTE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_NOTE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_SERVICE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_SERVICE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_IRRIGATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_IRRIGATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_TRANSPLANTING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_TRANSPLANTING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SCOUTING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_SCOUTING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_HARVEST_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
        db.execSQL("ALTER TABLE " + CROP_HARVEST_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CONTACT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID + " INTEGER DEFAULT NULL");
    ...
    public ArrayList<CropSpraying> getCropSprayings(String cropId) {
        ...
        while (!res.isAfterLast()) {
            ...
            spraying.setDaysBefore(res.getString(res.getColumnIndex(CROP_SPRAYING_DAYS_BEFORE)));
