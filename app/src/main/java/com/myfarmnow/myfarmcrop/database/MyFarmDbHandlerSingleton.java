...
public class MyFarmDbHandlerSingleton extends SQLiteOpenHelper {
    ...
    public void upGradingTablesFromVersion1ToVersion2(SQLiteDatabase db){
        ...
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SEEDS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SEEDS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SPRAY_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_INVENTORY_SPRAY_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CROP_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_CROP_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CULTIVATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_CULTIVATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_APPLICATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_APPLICATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SPRAYING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SPRAYING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FIELDS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_FIELDS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SOIL_ANALYSIS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SOIL_ANALYSIS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_EMPLOYEE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_EMPLOYEE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CUSTOMER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_CUSTOMER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SUPPLIER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SUPPLIER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PRODUCT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_PRODUCT_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_ESTIMATE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_ESTIMATE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PRODUCT_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_PRODUCT_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INVOICE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_INVOICE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_INCOME_EXPENSE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_INCOME_EXPENSE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PAYMENT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_PAYMENT_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_TASK_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_TASK_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SALES_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SALES_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PURCHASE_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_PURCHASE_ORDER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_PAYMENT_BILL_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_PAYMENT_BILL_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_BILL_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_BILL_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_ITEM_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_FERTILIZER_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SETTINGS_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SETTINGS_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_NOTIFICATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_NOTIFICATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_TASK_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_TASK_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_NOTE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_NOTE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_MACHINE_SERVICE_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_MACHINE_SERVICE_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_IRRIGATION_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_IRRIGATION_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_TRANSPLANTING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_TRANSPLANTING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_SCOUTING_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_SCOUTING_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_HARVEST_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
        db.execSQL("ALTER TABLE " + CROP_HARVEST_TABLE_NAME + " ADD COLUMN " + CROP_SYNC_STATUS + " TEXT DEFAULT 'no'");

        db.execSQL("ALTER TABLE " + CROP_CONTACT_TABLE_NAME + " ADD COLUMN " + CROP_GLOBAL_ID +" TEXT DEFAULT NULL UNIQUE");
