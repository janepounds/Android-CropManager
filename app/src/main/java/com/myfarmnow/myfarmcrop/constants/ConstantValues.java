package com.myfarmnow.myfarmcrop.constants;
...
public class ConstantValues {
    ...
    public static final String ECOMMERCE_URL = "http://emaishaadmin.myfarmnow.com/";
    ...
    public static final Boolean CUSTOMER_HAS_WALLET = false;
